...
final class CircularTrancsition: NSObject {
    
    private var circle = UIView()
    
    internal var circleColor: UIColor = .white
    internal var duration = 0.3
    internal var transitionMode: CircularTransitionMode = .present
    internal var startingPoint = CGPoint.zero {
        didSet {
...
extension CircularTrancsition: UIViewControllerAnimatedTransitioning {
